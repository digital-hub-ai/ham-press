...
export default function WorldPage() {
  // Professional world news articles targeted at high CPM countries (USA, UK, Germany)
  const articles = [
    {
  ...
  const regionalData = [
    { region: "Americas", percentage: 42, color: "bg-[#2563EB]" },
    { region: "Europe", percentage: 31, color: "bg-[#8B5CF6]" },
    { region: "Asia", percentage: 18, color: "bg-[#F59E0B]" },
    { region: "Oceania", percentage: 6, color: "bg-[#10B981]" },
    { region: "Africa", percentage: 3, color: "bg-[#EC4899]" }
  ];
    ...
    <div className="container py-12">
      ...
      <div className="mb-16 text-center max-w-4xl mx-auto">
        ...
        <p className="text-2xl text-[#E2E8F0] max-w-3xl mx-auto leading-relaxed mb-10">
          Comprehensive international reporting from our global network of correspondents. 
          Expert analysis on politics, economics, culture, and technology from every corner of the world.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-12">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-medium text-white">240K Daily Readers</span>
          </div>
          <div className="flex items-center gap-3">
            <MapPin className="h-6 w-6 text-[#F59E0B]" />
            <span className="text-xl font-medium text-white">120+ Countries</span>
          </div>
          <div className="flex items-center gap-3">
            <User className="h-6 w-6 text-[#2563EB]" />
            <span className="text-xl font-medium text-white">500+ Journalists</span>
          </div>
        </div>
      ...
      <div className="mb-16">
        <Card className="bg-gradient-to-br from-[#0F172A] to-[#1A1A2E] border border-[#64748B]/30 rounded-3xl overflow-hidden">
          <CardHeader>
            <CardTitle className="text-2xl text-white">Global News Distribution</CardTitle>
            <CardDescription className="text-[#E2E8F0]">
              Our coverage spans across continents with dedicated bureaus in major world capitals
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex items-center justify-center">
                <div className="relative w-64 h-64">
                  ...
                  <div className="absolute inset-0 rounded-full border-8 border-[#2563EB]"></div>
                  <div className="absolute inset-8 rounded-full border-8 border-[#8B5CF6]"></div>
                  <div className="absolute inset-16 rounded-full border-8 border-[#F59E0B]"></div>
                  <div className="absolute inset-24 rounded-full border-8 border-[#10B981]"></div>
                  <div className="absolute inset-32 rounded-full border-8 border-[#EC4899]"></div>
                </div>
              </div>
            </div>
          </CardContent>
      ...
      <div className="mt-24 rounded-3xl bg-gradient-to-r from-[#0A0A0F] to-[#1A1A2E] p-12 border border-[#2563EB]/30 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          <h2 className="text-4xl font-bold mb-6 text-white">Unlock Exclusive Global Insights</h2>
          <p className="text-xl text-[#E2E8F0] mb-8 max-w-2xl mx-auto">
            Join LuminaPress Premium to access in-depth analysis, exclusive interviews, and early access to breaking news from around the world.
          </p>
